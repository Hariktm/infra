...
#             # Extract Tower from Description
#             description = cleaned_record["Description"]
#             if description:
#                 tower_match = re.search(r"(Tower|T)\s*-?\s*\d+", description, re.IGNORECASE)
#                 cleaned_record["Tower"] = tower_match.group(0) if tower_match else "Unknown"
#             else:
#                 cleaned_record["Tower"] = "Unknown"
...
#                 f"Condition for {report_type} NCRs: {'absolute value of Days > 21' if report_type == 'Closed' else 'open more than 21 days as of the specified end date'}.\n"
